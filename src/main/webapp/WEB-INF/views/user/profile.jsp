		...
		<div class="profile-right">
			...
			<div class="subscribe">
				<ul>
					...
					<li><a href="javascript:subscribeInfoModalOpen(${dto.user.id });"> 구독한 정보<span>${dto.subscribeCount}</span>
					</a></li>
					<li><a href="javascript:subscribeInfoModalOpen2(${dto.user.id });"> 구독자 정보<span>${dto.subscribeMeCount}</span>
					</a></li>
